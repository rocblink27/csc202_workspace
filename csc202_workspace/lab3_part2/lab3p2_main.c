...
//    bitwise operations in Assembly. It includes a series of problems, each 
...
int main(void)
{
  ...
  reg_value  = test_reg16;
  reg_value  = my_asm_16bitset(reg_value, (A3_BIT_MASK | A2_BIT_MASK | 
  ...
  // enter your code here for problem 8
  reg_value  = test_reg16;
  if (my_asm_16bitcheck (reg_value, MODE_BIT_MASK))
  {
  ...
  else
  {
    ...
    reg_value = my_asm_16bitclr(reg_value, MODE_BIT_MASK);
  ...
  // enter your code here for problem 1
  reg_value  = test_reg16;
  reg_value = my_asm_16bitclr(reg_value, (A3_BIT_MASK |  A2_BIT_MASK | A1_BIT_MASK |
