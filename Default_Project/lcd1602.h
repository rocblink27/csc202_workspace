...
#define LCD_RS_BIT_MASK                                                   (1<<0)
#define LCD_RW_BIT_MASK                                                   (1<<1)
#define LCD_EN_BIT_MASK                                                   (1<<2)
#define LCD_BACKLIGHT_BIT_MASK                                            (1<<3)
